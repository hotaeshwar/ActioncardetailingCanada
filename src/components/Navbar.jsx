        ...
        <div className="transition-all duration-300">
          <div className="max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8">
            <div className="flex items-center justify-between h-28 sm:h-32 md:h-36 lg:h-28 xl:h-32 relative px-2 sm:px-3 md:px-4">
              ...
              {/* Award Logo - ENLARGED version */}
              <div className="flex-shrink-0 transform transition-transform hover:scale-105 cursor-pointer z-20 lg:w-80 lg:flex lg:justify-center lg:items-center min-w-0 hidden sm:flex">
                <a
                ...
                >
                  <img
                    className="h-32 lg:h-36 xl:h-40 w-auto filter drop-shadow-lg max-w-[160px] lg:max-w-[180px] xl:max-w-[200px] object-contain -mt-2"
                    src={awardLogo}
