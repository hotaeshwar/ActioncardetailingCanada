...
import XpelUltimateLogo from '../assets/images/XPEL_ULTIMATE_PLUS_logo.png';
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative">
                ...
                <div className="animate-bounce bg-[#1393c4]/90 p-2 rounded-full shadow-lg">
                  <svg xmlns="http://www.w3.org/0/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
